<?php
/*
Plugin Name: WeWP Redis Object Cache Drop-In
Plugin URI: https://www.wewp.io/
Description: A persistent object cache backend powered by Redis. Supports Predis, PhpRedis, HHVM, replication, clustering and WP-CLI.
Version: 1.5.1
Author: wewp
Author URI: https://www.wewp.io/
License: GPLv3
...
function get_cache_key_salt() {
    if ( defined( 'WEWP_CACHE_KEY_SALT' ) ) {
        return WEWP_CACHE_KEY_SALT;
    }
    if ( getenv( 'WEWP_CACHE_KEY_SALT' ) ) {
        return getenv( 'WEWP_CACHE_KEY_SALT' );
    }
