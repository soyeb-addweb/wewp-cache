...
class Plugin {
	...
	public function run() {
		...
		$cli->register_command( 'WeWP', Commands::class );
		...
		add_filter( 'wewp_should_use_object_cache_dropin', array( $this, 'should_use_object_cache_dropin' ) );
	}
	...
	public static function install() {
		...
		if ( ! file_exists( $wpmu_dir . '/wewp-debug-log-path.php' ) ) {
			wp_mkdir_p( $wpmu_dir );
			@copy( $plugin_path . '/mu-plugins/wewp-debug-log-path.php', $wpmu_dir . '/wewp-debug-log-path.php' );
		}
	...
	public static function update_object_cache_dropin() {
		...
		if ( ! apply_filters( 'wewp_should_use_object_cache_dropin', true ) ) {
			return false;
		}
	...
	public static function uninstall() {
		...
		if ( file_exists( $wpmu_dir . '/wewp-debug-log-path.php' ) ) {
			@unlink( $wpmu_dir . '/wewp-debug-log-path.php' );
		}
		...
		delete_site_option( 'wewp_redis_cache_disabled' );
		delete_site_option( 'wewp_mail_notice_dismissed' );
		delete_site_option( 'wewp_redis_cache_disabled_notice_dismissed' );
	}
	...
	public function admin_init() {
		if ( is_plugin_active( 'redis-cache/redis-cache.php' ) ) {
			...
			update_site_option( 'wewp_redis_cache_disabled', true );
		}
	}
}
